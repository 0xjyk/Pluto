...
# 8 "../../executables/lcc/src/c.h" 2
# 66 "../../executables/lcc/src/c.h"
...
# 1 "../../executables/lcc/src/config.h" 1
...
# 1 "../../executables/lcc/src/token.h" 1
...
# 2 "../../executables/lcc/src/main.c" 2
...
Interface *IR = 
# 9 "../../executables/lcc/src/main.c" 3 4
               ((void *)0)
# 9 "../../executables/lcc/src/main.c"
                   ;
...
int main(int argc, char *argv[]) {
 ...
 if (i > 0) {
  ...
  if (s != 
# 31 "../../executables/lcc/src/main.c" 3 4
          ((void *)0)
# 31 "../../executables/lcc/src/main.c"
              )
   *s = '/';
  ...
  if (s != 
# 38 "../../executables/lcc/src/main.c" 3 4
          ((void *)0)
# 38 "../../executables/lcc/src/main.c"
              )
   *s = '\\';
 }
 if (!IR) {
  fprint(
# 42 "../../executables/lcc/src/main.c" 3 4
        stderr
# 42 "../../executables/lcc/src/main.c"
              , "%s: unknown target", argv[0]);
  if (i > 0)
   fprint(
# 44 "../../executables/lcc/src/main.c" 3 4
         stderr
# 44 "../../executables/lcc/src/main.c"
               , " `%s'", &argv[i][8]);
  fprint(
# 45 "../../executables/lcc/src/main.c" 3 4
        stderr
# 45 "../../executables/lcc/src/main.c"
              , "; must specify one of\n");
  for (i = 0; bindings[i].name; i++)
   fprint(
# 47 "../../executables/lcc/src/main.c" 3 4
         stderr
# 47 "../../executables/lcc/src/main.c"
               , "\t-target=%s\n", bindings[i].name);
  exit(
# 48 "../../executables/lcc/src/main.c" 3 4
      1
# 48 "../../executables/lcc/src/main.c"
                  );
 }
 init(argc, argv);
 t = gettok();
...
# 57 "../../executables/lcc/src/main.c" 3 4
                                  ((void *)0)
# 57 "../../executables/lcc/src/main.c"
                                      , 1);
...
# 65 "../../executables/lcc/src/main.c" 3 4
                                   ((void *)0)
# 65 "../../executables/lcc/src/main.c"
                                       , 1);
   ...
   YYnull->type = func(voidptype, 
# 72 "../../executables/lcc/src/main.c" 3 4
                                 ((void *)0)
# 72 "../../executables/lcc/src/main.c"
                                     , 1);
   YYnull->sclass = EXTERN;
   (*IR->defsymbol)(YYnull);
  } else {
 ...
 if (events.end)
  apply(events.end, 
# 83 "../../executables/lcc/src/main.c" 3 4
                   ((void *)0)
# 83 "../../executables/lcc/src/main.c"
                       , 
# 83 "../../executables/lcc/src/main.c" 3 4
                         ((void *)0)
# 83 "../../executables/lcc/src/main.c"
 ...
 if (glevel || xref) {
  Symbol symroot = 
# 86 "../../executables/lcc/src/main.c" 3 4
                  ((void *)0)
# 86 "../../executables/lcc/src/main.c"
                      ;
  Coordinate src;
  ...
  if ((glevel > 2 || xref) && IR->stabend)
   (*IR->stabend)(&src, symroot,
    ltov(&loci, PERM),
    ltov(&symbols, PERM), 
# 96 "../../executables/lcc/src/main.c" 3 4
                         ((void *)0)
# 96 "../../executables/lcc/src/main.c"
                             );
  else if (IR->stabend)
   (*IR->stabend)(&src, 
# 98 "../../executables/lcc/src/main.c" 3 4
                       ((void *)0)
# 98 "../../executables/lcc/src/main.c"
                           , 
# 98 "../../executables/lcc/src/main.c" 3 4
                             ((void *)0)
# 98 "../../executables/lcc/src/main.c"
...
void main_init(int argc, char *argv[]) {
 char *infile = 
# 107 "../../executables/lcc/src/main.c" 3 4
               ((void *)0)
# 107 "../../executables/lcc/src/main.c"
                   , *outfile = 
# 107 "../../executables/lcc/src/main.c" 3 4
                                ((void *)0)
# 107 "../../executables/lcc/src/main.c"
  ...
  if (strcmp(argv[i], "-g") == 0 || strcmp(argv[i], "-g2") == 0)
   ...
   if (p) {
    ...
    if (glevel == 0)
     glevel = 1;
    if (stabIR.stabline == 
# 124 "../../executables/lcc/src/main.c" 3 4
                          ((void *)0)
# 124 "../../executables/lcc/src/main.c"
                              ) {
   ...
   fprint(
# 140 "../../executables/lcc/src/main.c" 3 4
         stderr
# 140 "../../executables/lcc/src/main.c"
               , "%s %s\n", argv[0], rcsid);
  else if (strncmp(argv[i], "-s", 2) == 0)
   density = strtod(&argv[i][2], 
# 142 "../../executables/lcc/src/main.c" 3 4
                                ((void *)0)
# 142 "../../executables/lcc/src/main.c"
                                    );
  else if (strncmp(argv[i], "-errout=", 8) == 0) {
   FILE *f = fopen(argv[i]+8, "w");
   if (f == 
# 145 "../../executables/lcc/src/main.c" 3 4
           ((void *)0)
# 145 "../../executables/lcc/src/main.c"
               ) {
    fprint(
# 146 "../../executables/lcc/src/main.c" 3 4
          stderr
# 146 "../../executables/lcc/src/main.c"
                , "%s: can't write errors to `%s'\n", argv[0], argv[i]+8);
    exit(
# 147 "../../executables/lcc/src/main.c" 3 4
        1
# 147 "../../executables/lcc/src/main.c"
                    );
   }
   fclose(f);
   f = freopen(argv[i]+8, "w", 
# 150 "../../executables/lcc/src/main.c" 3 4
                              stderr
# 150 "../../executables/lcc/src/main.c"
                                    );
   
# 151 "../../executables/lcc/src/main.c" 3 4
  ((
# 151 "../../executables/lcc/src/main.c"
  f
# 151 "../../executables/lcc/src/main.c" 3 4
...
# 151 "../../executables/lcc/src/main.c"
  "f"
# 151 "../../executables/lcc/src/main.c" 3 4
  , "../../executables/lcc/src/main.c", 151, __extension__ __PRETTY_FUNCTION__))
# 151 "../../executables/lcc/src/main.c"
           ;
  } else if (strncmp(argv[i], "-e", 2) == 0) {
   int x;
   if ((x = strtol(&argv[i][2], 
# 154 "../../executables/lcc/src/main.c" 3 4
                               ((void *)0)
# 154 "../../executables/lcc/src/main.c"
                                   , 0)) > 0)
    errlimit = x;
   ...
   if (infile == 
# 169 "../../executables/lcc/src/main.c" 3 4
                ((void *)0)
# 169 "../../executables/lcc/src/main.c"
                    )
    infile = argv[i];
   else if (outfile == 
# 171 "../../executables/lcc/src/main.c" 3 4
                      ((void *)0)
# 171 "../../executables/lcc/src/main.c"
                          )
    outfile = argv[i];
  }

 if (infile != 
# 175 "../../executables/lcc/src/main.c" 3 4
              ((void *)0) 
# 175 "../../executables/lcc/src/main.c"
                   && strcmp(infile, "-") != 0
 && freopen(infile, "r", 
# 176 "../../executables/lcc/src/main.c" 3 4
                        stdin
# 176 "../../executables/lcc/src/main.c"
                             ) == 
# 176 "../../executables/lcc/src/main.c" 3 4
                                  ((void *)0)
# 176 "../../executables/lcc/src/main.c"
  ...
  fprint(
# 177 "../../executables/lcc/src/main.c" 3 4
        stderr
# 177 "../../executables/lcc/src/main.c"
              , "%s: can't read `%s'\n", argv[0], infile);
  exit(
# 178 "../../executables/lcc/src/main.c" 3 4
      1
# 178 "../../executables/lcc/src/main.c"
                  );
 }
 if (outfile != 
# 180 "../../executables/lcc/src/main.c" 3 4
               ((void *)0) 
# 180 "../../executables/lcc/src/main.c"
                    && strcmp(outfile, "-") != 0
 && freopen(outfile, "w", 
# 181 "../../executables/lcc/src/main.c" 3 4
                         stdout
# 181 "../../executables/lcc/src/main.c"
                               ) == 
# 181 "../../executables/lcc/src/main.c" 3 4
                                    ((void *)0)
# 181 "../../executables/lcc/src/main.c"
  ...
  fprint(
# 182 "../../executables/lcc/src/main.c" 3 4
        stderr
# 182 "../../executables/lcc/src/main.c"
              , "%s: can't write `%s'\n", argv[0], outfile);
  exit(
# 183 "../../executables/lcc/src/main.c" 3 4
      1
# 183 "../../executables/lcc/src/main.c"
                  );
 }
}
...
# 211 "../../executables/lcc/src/main.c" 3 4
                                       ((void *)0)
# 211 "../../executables/lcc/src/main.c"
                                           ) {
    fclose(srcfp);
    srcfp = 
# 213 "../../executables/lcc/src/main.c" 3 4
           ((void *)0)
# 213 "../../executables/lcc/src/main.c"
               ;
    break;
   }
